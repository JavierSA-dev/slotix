...
<head>
    ...
    <style>
        ...
        .alert-box { background: #fff8e6; border-left: 4px solid #c69444; border-radius: 6px; padding: 14px 18px; margin-bottom: 20px; font-size: 14px; color: #7a5c1e; font-weight: 600; }
...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <div class="alert-box">
                ⏰ Tienes una reserva mañana. ¡No se te olvide!
            </div>
            ...
            <p style="font-size:13px;color:#777;">Si no puedes asistir, cancela tu reserva con tiempo desde el siguiente enlace:</p>
            <a href="{{ route('reservas.show', [$empresaSlug, $reserva->token]) }}" class="btn">Gestionar mi reserva</a>
        </div>
        <div class="footer">
            {{ $empresaNombre }} · Este recordatorio se envió automáticamente
        </div>
    </div>
</body>
</html>
