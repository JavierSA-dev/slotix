...
return [
  ...
  "hot" => "Caliente",
  "backend" => "Backend",
  "yajra-datatable" => "Datatable yajra",
  "View_Profile" => "Ver cuenta",
  "Administration" => "Administración",
  "Users" => "Usuarios",
  "User_Editar" => "Editar Usuario",
  "User_Nuevo" => "Nuevo Usuario",
  "User_DatosPersonales" => "Datos Personales",
  "User_Permisos" => "Permisos",
  "Otras_aplicaciones" => "Otras aplicaciones",
  "Guardar" => "Guardar",
  "Eliminar" => "Eliminar",
  ...
  "DejarVacioParaMantener" => "dejar vacío para mantener la actual",
  "Roles" => "Perfiles",
  "Permisos" => "Permisos",
  "Configuracion" => "Configuracion",
  "Seleccione" => "Elija una opción",
];
